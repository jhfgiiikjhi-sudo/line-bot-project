...
function isExtremelyBad(text) {
    ...
    const whiteList = ["สวัสดี", "หวัดดี", "ขอบคุณ", "ครับ", "ค่ะ"];
...
async function handleEvent(event) {
    ...
    if (lower === "ยกเลิก" || lower === "เริ่มใหม่") {
        ...
        await user.save();
        return reply(event, "รีเซ็ตระบบลงทะเบียนแล้วครับ พิมพ์ **ชื่อจริง** ใหม่ได้เลย");
    }
...
// 1. ตั้งค่าพอร์ตเป็น 8080 ตามที่ต้องการ
