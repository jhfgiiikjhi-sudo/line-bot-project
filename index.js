...
const EXTREME_BAD_PATTERNS = [
    // ปรับให้ดักพยัญชนะคั่นได้ไม่เกิน 2 ตัว เพื่อไม่ให้โดนคำว่า "เรียน"
    /[คข].{0,2}[วภ].{0,2}[ยญ]/,        
    /[เหเ].{0,2}ี.{0,2}้.{0,2}ย/,      // ดัก "เหี้ย" แต่จะไม่โดน "เรียน" เพราะตัว "้" กับ "ย" อยู่ห่างกันเกินไป
    /[สส].{0,2}ั.{0,2}[สส]/,          
    /ห.{0,1}ี/,                       
    /[เยเ].{0,2}็.{0,2}ด/,            
    ...
    // ดักภาษาอังกฤษ (Case-insensitive)
...
// ฟังก์ชันดึงข่าว (วางไว้ส่วนบนของไฟล์)
